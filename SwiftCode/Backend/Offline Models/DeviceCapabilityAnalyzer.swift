        ...
        case .low:
            return [
                RecommendedOfflineModel(
                    ...
                    reason: "Optimized for low-memory \(capabilities.deviceClass) devices with \(Int(capabilities.totalRAMGB)) GB RAM.",
                ...
                RecommendedOfflineModel(
                    ...
                    reason: "Good quality for 1B-3B inference on constrained CPU/GPU devices.",
        ...
        case .medium:
            return [
                RecommendedOfflineModel(
                    ...
                    reason: "Balanced 3B model that fits medium-tier RAM and storage budgets.",
                ...
                RecommendedOfflineModel(
                    ...
                    reason: "Suitable for medium tier devices with stable quantized performance.",
        ...
        case .high:
            return [
                RecommendedOfflineModel(
                    ...
                    reason: "High-tier hardware can sustain larger quantized 7B-class models.",
                ...
                RecommendedOfflineModel(
                    ...
                    reason: "Best quality recommendation for high RAM and stronger GPU capability.",
